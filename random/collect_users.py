...
def automate():
    ...
    follow_usernames = set(u['username'] for u in following)
    follower_usernames = set(u['username'] for u in followers)

    to_follow = follower_usernames - follow_usernames
    to_unfollow = follow_usernames - follower_usernames
